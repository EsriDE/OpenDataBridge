...
public class Transformer {
    ...
    public static void main(String[] args) {
        ...
        agolItem.getAttributes().put("agol.accessInformation", "Text zu Zugangsinformation");
        agolItem.getAttributes().put("agol.description", "Produktbeschreibung");
        agolItem.getAttributes().put("agol.extent", "5.725,50.1506,9.5315,52.602");
        agolItem.getAttributes().put("agol.tags", "NRW,DTK100");
        ...
        agolItem.getAttributes().put("agol.thumbnailURL", "http://www.wms.nrw.de/geobasis/adv_dtk100?SERVICE=WMS&REQUEST=GetMap&FORMAT=image/png&TRANSPARENT=TRUE&STYLES=&VERSION=1.1.1&LAYERS=DTK100&WIDTH=200&HEIGHT=133&SRS=EPSG:4326&BBOX=5.72499,50.1506,9.53154,52.602");
        agolItem.getAttributes().put("agol.title","AGOL Titel");
        agolItem.getAttributes().put("agol.type","WMS");
        agolItem.getAttributes().put("agol.typeKeywords","Data, Service, Web Map Service, OGC");
        agolItem.getAttributes().put("agol.url", "http://www.wms.nrw.de/geobasis/adv_dtk100");
