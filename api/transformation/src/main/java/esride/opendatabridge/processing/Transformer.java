...
public class Transformer {
    ...
    public void executeProcessTransformation(IReader reader, IAgolService agolService, PipelineController pipelineController, IAgolItemReader agolReader,
        ...
        //hole die Items vom Katalog in 50 Bloecken
        ...
        //hier werden die ersten 50 Eintraege geholt
        //durchlaufen der OdbItemPipeline
        /**
         * 1) ins OdbItem Format transformieren
         * 2) ResourceFormate rausschmeißen und Typ einheitlich anpassen (z.B. WMS OGC, etc...)
         * 3) URL bereinigen
         * 3) Enrichment (Capabilities|KML|....)
         * 4) SRS Validator
         * 5) License Validator
         * 6) Enricher catalogId
         *
         *
         */

         //nun wird gemeged wenn noetig und nach AGOL transformiert
